import { GenerationParam, Img2imgParam, Txt2imgParam } from "../lib/schema";
    ...
    public async generate(session: GenerateSession, option: {
        ...
        for (let index = 0; index < (option.batch || 1); index++) {
            ...
            if (maybeImgtoImgParam.init_images && maybeImgtoImgParam.init_images.length) {
                ...
                res = await SDApi.img2img(this, param as Img2imgParam);

            } else {
                res = await SDApi.txt2img(this, param as Txt2imgParam);
            }
