import { DetectParam, Img2imgParam, Txt2imgParam, ExtraParam } from "../lib/schema";
import SDServer from "./SDServer";


export class SDApi {
    public static async txt2img(sd: SDServer, param: Txt2imgParam) {
        // console.log(param)
        return await sd.post("/sdapi/v1/txt2img", param);
    }
    public static async img2img(sd: SDServer, param: Img2imgParam) {
        // console.log(param)
    ...
    public static async extraBatchImages(sd: SDServer, param: ExtraParam) {
    ...
    public static async controlnetDetect(sd: SDServer, param: DetectParam): Promise<string[]> {
